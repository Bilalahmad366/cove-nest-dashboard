<template>
  <div>
    ...
    <div class="relative flex min-h-screen items-center justify-center bg-[url(/assets/images/auth/map.png)] bg-cover bg-center bg-no-repeat px-6 py-4 dark:bg-[#060818] sm:px-16">
      <img src="/assets/images/auth/coming-soon-object1.png" alt="image" class="absolute left-0 top-1/2 h-full max-h-[603px] -translate-y-1/2" />
        ...
        <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
          ...
          <div class="w-full max-w-[440px] lg:mt-16">
            ...
            <form class="space-y-5 dark:text-white" @submit.prevent="login">
              ...
              >
                ...
                <div class="relative text-white-dark">
                  <input v-model.trim="$v.form.email.$model" id="Email" type="email" placeholder="Enter Email" class="form-input ps-10 placeholder:text-white-dark" />
              ...
              >
                ...
                <div class="relative text-white-dark">
                  <input v-model.trim="$v.form.password.$model" id="Password" type="password" placeholder="Enter Password" class="form-input ps-10 placeholder:text-white-dark" />
                  <span class="absolute start-4 top-1/2 -translate-y-1/2">
              ...
              <div>
                <router-link to="/forgot-password" class="text-blue-500 text-base block hover:underline">Forgot Password?</router-link>
              </div>
              <!-- Error Message -->
            ...
            <div class="text-center dark:text-white mt-2">
              ...
              <router-link to="/register" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white"> SIGN UP </router-link>
            </div>
          </div>
